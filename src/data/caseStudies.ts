...
export const caseStudies: CaseStudy[] = [
  {
    ...
    after: [
      "Höherstufung auf PG5",
      "+ Hilfe zur Pflege (SGB XII)",
      "Verbleib zu Hause statt Heimunterbringung",
    ],
    result: "+2.800€/Monat",
  ...
  },
  {
    ...
    after: [
      ...
      "Beruf trotz MS – Arbeitsplatz gesichert",
    ],
    result: "+3.200€/Monat",
  ...
  },
  {
    ...
    after: [
      "Höherstufung auf PG4",
      "Kombileistung + Kurzzeitpflege",
      "Ehefrau hat wieder Zeit für sich",
    ],
    result: "+2.400€/Monat",
