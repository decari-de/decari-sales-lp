...
export const benefits: Benefit[] = [
  {
    title: "+3.000€/Monat",
    description:
      "Mehrumsatz pro Klient mit Zusatzanspruch – bei denselben Klienten",
  ...
  {
    title: "Zufriedenere Teams",
    description:
      "Längere Einsätze statt Hektik – weniger Fluktuation, leichteres Recruiting",
    iconPath:
